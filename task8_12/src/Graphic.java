...
class Graphic{
    ...
    public Graphic(){
        ...
        openTableScreen(openArrayFromFile(getFilePath("Выберите файл")));
    }
    ...
    private void packButtonInPanel(JPanel panel, int displayWidth, int displayHeight){
        ...
        openButton.addActionListener(e -> {
            this.clear();
            this.openTableScreen(openArrayFromFile(getFilePath( "Выберите файл")));
        });

        JButton moverRow=new JButton("Вверх");
        ...
        JButton moverColumn=new JButton("Влево");
